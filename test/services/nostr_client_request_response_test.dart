...
void main() {
  group('NostrClient - request - responce', () {
    ...
    test('request - responce', () async {
      ...
      expect(requests[0], r'["REQ","uuid-v4",{"kinds":[4],"limit":5}]');
    });
  });
}
