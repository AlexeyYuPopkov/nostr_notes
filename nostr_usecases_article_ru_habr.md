...
Private Notes (Nostr) написано мной и выложено в открытый доступ (исходный код — на GitHub, ссылка в разделе «Заметки» выше). Сборки: [App Store](https://apps.apple.com/bg/app/private-notes-nostr/id6757975921), [веб-версия](https://alexeyyupopkov.github.io), [Android (APK)](https://alexeyyupopkov.github.io/downloads/nostr_notes-release.apk).
