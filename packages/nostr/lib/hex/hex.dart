...
final class HexCodec extends Codec<List<int>, String> {
  static const hex = HexCodec();
  const HexCodec();
...
final class HexEncoder extends Converter<List<int>, String> {
...
final class HexDecoder extends Converter<String, List<int>> {
  const HexDecoder();
