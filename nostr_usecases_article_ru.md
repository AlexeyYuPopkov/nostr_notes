...
Собственно, именно так и появился мой пет-проект — **Private Notes (Nostr)**: кроссплатформенное приложение для заметок с end-to-end шифрованием на устройстве (NIP-44), подписью через secp256k1 и хранением на выбранных пользователем реле. Ни сервера, ни аккаунтов — только пара ключей. Попробовать можно прямо сейчас:
...
- 🤖 **Android:** [скачать APK](https://alexeyyupopkov.github.io/downloads/nostr_notes-release.apk)
- 💻 **Исходный код:** [github.com/AlexeyYuPopkov/nostr_notes](https://github.com/AlexeyYuPopkov/nostr_notes)

Репозиторий открытый — если найдёте баг или у вас есть идея, не стесняйтесь заводить [Issue](https://github.com/AlexeyYuPopkov/nostr_notes/issues), буду рад обратной связи.
...
Хотя без умной выдачи, может, и лучше ) А то как-то не здорово, что найти понравившийся пост повторно часто не получается...
...
Меня зовут Алексей Попков, я Flutter-разработчик. Всё, о чём шла речь в этой статье, — это мой практический опыт: я участвовал в разработке двух Nostr-приложений, от end-to-end шифрованных заметок до групповых чатов, лент, communities и организаций с ролевой моделью. Из близких тем — чистая архитектура, кроссплатформа (iOS, Android, macOS, Web), нативный код через FFI (secp256k1 на C++), криптография и децентрализованные протоколы.

Приложение из этой статьи — [Private Notes (Nostr)](https://github.com/AlexeyYuPopkov/nostr_notes) — целиком написано мной и выложено в открытый доступ; можете полистать код, чтобы оценить подход.

Открыт к интересным проектам и сотрудничеству. Связаться со мной можно здесь:

- 📧 Email: [alexey.yu.popkov@gmail.com](mailto:alexey.yu.popkov@gmail.com)
- 📱 Telegram: [@alexey_yu_popkov](https://t.me/alexey_yu_popkov)
- 💼 LinkedIn: [alekseii-popkov](https://www.linkedin.com/in/alekseii-popkov-57007282)
